        ...
        <table class="table table-hover" id="table" style="width: 120rem;">
            ...
            @foreach ($stds as $std)
                <tr>
                    ...
                    <td>{{ $std->lastname }}</td>
                    <td>
                        <button type="button" class="btn btn-danger" onclick="removeStd(this.id)"
                                id="btnAdd{{ $std->student_id }}">Remove
                        </button>
                    </td>
                </tr>
            @endforeach
                        ...
                        <table class="table table-hover" id="tableAddStd" style="width:74rem;">
                            ...
                            @foreach ($allStd as $std)
                                ...
                                <tr id="rowID{{ $std->student_id }}">
                                    ...
                                    <td>{{ $std->lastname }}</td>
                                    <td>
                                        <button type="button" class="btn btn-info" onclick="addStdBtn(this.id)"
                                                value="0" id="btnAdd{{ $std->student_id }}">
                                            Add
                                        </button>
...
<center>
    <div class="row" style="margin-top: 30px; margin-bottom: 30px; width: 120rem;">
        ...
        <div class="col ">
            <button class="btn btn-secondary" onclick="window.location.href='/editAcademic/{{$cur_year}}'">Back to edit
                academic year
            </button>
        </div>
