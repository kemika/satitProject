      ...
      <tbody>
        ...
        <?php $c+=1 ?>
          <tr>
            ...
            <td><button type="button" class="btn btn-danger" onclick="removeSubject(''+{{ $sub->open_course_id }});">
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <form class="form-inline" id="editForm{{$c}}" onsubmit="editSubject(this.id);return false;" method="post">
                  @csrf
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="text" class="form-control" value='{{ $sub->course_id }}' readonly>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="number" class="form-control" name="semester" value='{{ $sub->semester }}' min="1" max="3" required required>
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-5">
                      <input type="number" class="form-control" name="credit" value='{{ $sub->credits }}'  min="0" max="3" step="0.5" required required>
                    </div>
                  </div>
            ...
            <table class="table table-hover"  style="width:74rem;" >
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>  <input type="text" class="form-control"  name="curYear" value='{{ $sub->curriculum_year }}' readonly></td>
                  </tr>

                  <tr>
                    <td class="text-right" >Course ID :</td>
                    <td>  <input type="text" class="form-control"  name="course_id" value='{{ $sub->course_id }}' readonly></td>
                  </tr>

                  <tr>
                    <td class="text-right" >Course Name :</td>
                    <td>  <input type="text" class="form-control"  name="course_name" value='{{ $sub->course_name }}' readonly></td>
                  </tr>

                  <tr>
                    <td class="text-right" >Semester :</td>
                    <td> <input type="number" class="form-control"  name="semester" value="1" min="1" max="3" required></td>
                  </tr>

                  <tr>
                    <td class="text-right">Credit :</td>
                    <td> <input type="number" class="form-control"  name="credit" min="0" max="3" step=0.5 required></td>
                  </tr>
